...
const Privacy_policy = () => {
  return (
    <div className='mx-20 my-10'>
      ...
      <p className='text-xl'><strong>Effective Date:</strong> {new Date().toLocaleDateString()}</p>
      ...
      <p className='text-xl'>If you have any questions about this Privacy Policy, please contact us at learn247@gmail.com.</p>
    </div>
  )
}
