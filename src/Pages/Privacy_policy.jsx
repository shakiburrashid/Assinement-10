...
const Privacy_policy = () => {
  return (
    <div className='mx-20 max-md:mx-10 text- my-10'>
      ...
      <h1 className='text-3xl font-bold text-left my-5 max-md:text-2xl'>Information We Collect</h1>
      ...
      <h1 className='text-3xl font-bold text-left my-5 max-md:text-2xl'>How We Use Your Information</h1>
      ...
      <h1 className='text-3xl font-bold text-left my-5 max-md:text-2xl'>Data Security</h1>
      ...
      <h1 className='text-3xl font-bold text-left my-5 max-md:text-2xl'>Your Rights</h1>
